...
const imagelogoReceivablePurchase = async (req, res) => {
  try {

    const result = await ReceivablePurchase.find().distinct('image')
    res.status(201).json({
      success: true,
      message: "imagelogoReceivablePurchase fethched successfully",
      image: result,
    });
...
module.exports = { ReceivablePurchaseCreate, AllReceivablePurchase, deleteReceivablePurchase, UpdateReceivablePurchase ,imagelogoReceivablePurchase};
